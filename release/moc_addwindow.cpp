...
QT_MOC_LITERAL(3, 20, 5) // "creat"

    },
    "AddWindow\0sendinfo\0\0creat"
};
...
static const uint qt_meta_data_AddWindow[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::QString, QMetaType::Int, QMetaType::Double, QMetaType::Double, QMetaType::Double,    2,    2,    2,    2,    2,
...
void AddWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendinfo((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< double(*)>(_a[3])),(*reinterpret_cast< double(*)>(_a[4])),(*reinterpret_cast< double(*)>(_a[5]))); break;
        ...
        {
            using _t = void (AddWindow::*)(QString , int , double , double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddWindow::sendinfo)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AddWindow::sendinfo(QString _t1, int _t2, double _t3, double _t4, double _t5)
{
